...
// This contract is identical to SavingsAccount except you can manipulate the current date

contract SavingsAccountMock is PriceFeedConsumer {
    ...
    function setCurrentDate(uint256 newFakeDate) public {
        currentDate = newFakeDate;
    }
